...
//     (!filterEmail || r.userEmail.toLowerCase().includes(filterEmail.toLowerCase()))
//   );
...
//           className="px-4 py-2 border rounded-lg bg-white text-sm shadow"
//         >
...
//           className="px-4 py-2 border rounded-lg flex-1 min-w-[200px] bg-white text-sm shadow"
//         />
//         <span className="text-sm text-gray-400 ml-auto mt-2 md:mt-0">
//           Showing {filtered.length} of {requests.length} records
//         </span>
//       </div>

//       <div className="overflow-auto rounded-2xl shadow border">
//         <table className="min-w-full bg-white text-[15px]">
//           <thead>
//             <tr className="bg-gray-50 border-b">
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">#</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">User</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">Amount</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">Bank</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">Account No</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">Name</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">Status</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">Requested</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">Processed</th>
//               <th className="py-4 px-3 font-bold text-left text-gray-700 whitespace-nowrap">Reason</th>
//               <th className="py-4 px-3 font-bold text-center text-gray-700 whitespace-nowrap">Actions</th>
//             </tr>
//           </thead>
//           <tbody>
//             {filtered.length === 0 ? (
...
//                   <td className="py-3 px-3 font-medium text-blue-900">{r.userEmail}</td>
//                   <td className="py-3 px-3 font-bold text-blue-700">₦{r.amount.toLocaleString()}</td>
//                   <td className="py-3 px-3">{r.bankName}</td>
//                   <td className="py-3 px-3">{r.accountNumber}</td>
//                   <td className="py-3 px-3">{r.accountName}</td>
//                   <td className="py-3 px-3">
//                     <span className={`inline-block px-3 py-1 rounded-full font-semibold text-xs ${statusColors[r.status]}`}>
//                       {r.status === 'paid'
//                         ? 'Paid'
...
//                   </td>
//                   <td className="py-3 px-3 text-xs text-red-500 max-w-[180px] truncate">
//                     {r.declineReason || '—'}
//                   </td>
...
//                           className="inline-block px-3 py-1 rounded-lg bg-green-600 text-white font-semibold text-xs hover:bg-green-700 transition"
//                         >
//                           Mark Paid
//                         </button>
//                         <button
//                           onClick={() => openModal(r, 'declined')}
//                           className="inline-block px-3 py-1 rounded-lg bg-red-600 text-white font-semibold text-xs hover:bg-red-700 transition"
//                         >
//                           Decline
//                         </button>
//                       </>
...
//                         className="inline-block px-3 py-1 rounded-lg bg-gray-200 text-gray-700 font-semibold text-xs hover:bg-gray-300 transition"
//                       >
//                         Delete
//                       </button>
//                     )}
