...
// Images live in /src/assets/howto/
...
const steps: Step[] = [
  ...
  },
  {
    ...
    text:
      "• Categories: Choose up to three that best match your video.\n• Suggested Number of Clips: Tell us how many versions the AI should generate. Leave 1 to use your original.\n\nWhen everything looks good, click Create Campaign. Your campaign moves to Live as soon as it's processed.",
    icon: <HiCheckCircle />,
    accent: "indigo",
  },
];
