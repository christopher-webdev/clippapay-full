...
const STATUS: Record<string, { label: string; color: string; bg: string; icon: string; cta: string }> = {
  ...
  expired:           { label: 'Expired',            color: '#EF4444', bg: '#FEF2F2', icon: 'alert-circle-outline',    cta: 'View details'                      },
...
const OTHER_STATUSES     = ['rejected','expired','withdrawn','disputed','disputed_resolved'];
  ...
  const renderItem = ({ item }: { item: Application }) => {
    ...
    return (
      <TouchableOpacity
        ...
        activeOpacity={0.88}
      >
        {/* Urgency indicator for action-needed items */}
...
const S = StyleSheet.create({
  hdr:       { paddingTop: 10, paddingBottom: 16, paddingHorizontal: 18 },
