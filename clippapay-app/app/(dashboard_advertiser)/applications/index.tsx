// app/(dashboard_advertiser)/applications/index.tsx
...
export default function ApplicationsList() {
  ...
  const handleViewApplication = (application: Application) => {
    ...
    router.push({
      pathname: '/(dashboard_advertiser)/applications/[id]',
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <SendOfferModal
        ...
        onConfirm={() => selectedApplication && handleSendOffer(selectedApplication._id)}
