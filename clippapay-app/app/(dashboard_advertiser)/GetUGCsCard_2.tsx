...
export default function GetUGCsCard_2() {
  return (
    <TouchableOpacity
      activeOpacity={0.9}
      style={styles.cardOuter}
      onPress={() => router.push('/onboarding_clipping')} // ← your route
    >
      <View style={styles.cardWrapper}>
        {/* Gradient inner card */}
        <LinearGradient
          colors={['#A43931', '#1D4350']}
          start={{ x: 0.5, y: 0.5 }}
          end={{ x: 0.5, y: 0 }}
        ...
        >
          ...
          <Image
            source={require('../../assets/images/ad_2.png')}
...
const styles = StyleSheet.create({
  cardOuter: {
    ...
    height: 230 * scale,
    alignSelf: 'center',
    marginTop: 5 * scale, // spacing from "Ready to launch..." text
  },
  cardWrapper: {
    flex: 1,
  ...
  bannerTextWrapper: {
    ...
    alignContent: 'center',
    // paddingLeft: 0 * scale, // offset to center text nicely
  },
  bannerText: {
    // fontFamily: 'OpenSans',
    fontWeight: '700',
