...
export default function DataDeletion() {
  ...
  const handleSubmit = () => {
    ...
    Linking.openURL('mailto:privacy@clippapay.com?subject=' + subject + '&body=' + body);
    setSubmitted(true);
  };
  ...
  return (
    <SettingsLayout title="Data Deletion Request">
      <Text style={S.intro}>
        Under the Nigeria Data Protection Act 2023 (NDPA), you have the right to request
        deletion of all personal data we hold about you. This will close your account permanently.
      </Text>

      <View style={S.warningBox}>
        <Text style={S.warningTitle}>Important — Please Read</Text>
      ...
      {!submitted ? (
        <>
          ...
          <Text style={S.alt}>
            ...
            <Text style={S.link} onPress={() => Linking.openURL('mailto:privacy@clippapay.com')}>
